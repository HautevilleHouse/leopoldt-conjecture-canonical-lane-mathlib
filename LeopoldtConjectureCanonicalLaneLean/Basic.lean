/-!
# leopoldt-conjecture-canonical-lane Lean migration boundary
...
`LeopoldtConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "leopoldt-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/leopoldt-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Leopoldt's conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-number-theory", "mathematical-proof", "number-theory", "reproducibility", "iwasawa-theory", "leopoldt-conjecture", "p-adic-regulators", "canonical-lane", "local-to-global", "manifold-constrained"]
