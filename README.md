# Leopoldt Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/leopoldt-conjecture-canonical-lane-mathlib.git
cd leopoldt-conjecture-canonical-lane-mathlib
lake exe
lake build
```
